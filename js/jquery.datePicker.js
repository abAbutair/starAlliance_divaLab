...
(function($) {
    ...
    $.datePicker = {
        default: {
            prev: '<i class="fas fa-chevron-circle-left"></i>',                          // change prev button. html is allowed.
            next: '<i class="fas fa-chevron-circle-right"></i>',                          // change next button. html is allowed.
