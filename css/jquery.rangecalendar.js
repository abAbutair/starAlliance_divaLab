...
$.fn.rangeCalendar = function(options) {
	...
	this.each(function(i, el) {
		...
		obj._getCalendarHTML = function(startDate,endDate) {
			...
			var endDayNumber = endDate.format('D');
            endDayNumber--;
...
//				console.log(date._d);//korashy
				...
				cell += '</div>';//date_price
				cell += '<div class="date"><span>'+ month +'</span><span class="day> '+( isWeekend ? 'ferial' : '') +'">'+day+'</span></div>';
                ...
                cell += '</div>';// cell
/*
					cell += '<div class="cal-cell cell" date-id="'+fullYear+monthNumber+endDayNumber+'" month-id="'+fullYear+''+monthNumber+'" month="'+monthNumber+'">';
					cell += '</div>';// cell
					*/
				...
				/*
					...
					cell += '</div>';// cell
*/
					cell = '<div class="cal-cell cell" date-id="" month-id="" month="">';
					cell += '<div class="cell-content">';
					cell += '<div class="date_price">';
					/*
					cell += '<div class="day-number">'+dayNumber+'</div>';
